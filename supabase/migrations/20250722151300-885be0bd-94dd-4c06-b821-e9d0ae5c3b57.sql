...
ALTER TABLE public.audio_tracks REPLICA IDENTITY FULL;
ALTER TABLE public.video_tracks REPLICA IDENTITY FULL;
...
ALTER PUBLICATION supabase_realtime ADD TABLE public.video_tracks;
